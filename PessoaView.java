...
public class PessoaView extends JFrame {
    ...
    private void configurarTela() {
        ...
        painelFormulario.add(new JLabel("Genero:"));
        ...
        modeloTabela = new DefaultTableModel(new String[]{"ID", "Nome", "Idade", "Genero","Telefone"}, 0);
        ...
        btnSalvar.addActionListener(e -> {
            try {
                ...
                controller.salvar(nome, idade, genero, telefone);
                atualizarTabela();
    ...
    private void atualizarTabela() {
        ...
        for (Pessoa p : controller.listarTodas()) {
            modeloTabela.addRow(new Object[]{p.getId(), p.getNome(), p.getIdade(), p.getGenero(), p.getTelefone()});
        }
    }
}